...
class MyApp extends StatelessWidget { const MyApp({super.key});
  @override Widget build(BuildContext context) {
    return MaterialApp(debugShowCheckedModeBanner: false, theme: ThemeData(scaffoldBackgroundColor: kBg, appBarTheme: const AppBarTheme(backgroundColor: kCard, foregroundColor: Colors.white)),
      home: Scaffold(appBar: AppBar(title: const Text('Analytics')),
        body: const Padding(padding: EdgeInsets.all(16), child: Center(child: Text('Firebase Analytics:\n\n📊 Auto-tracks screen views\n📈 Log custom events\n👥 User properties\n📱 Works on iOS and Android\n\nCode:\nFirebaseAnalytics.instance\n  .logEvent(name: "purchase");', style: TextStyle(color: Colors.white, fontSize: 18))))));
  }
}
