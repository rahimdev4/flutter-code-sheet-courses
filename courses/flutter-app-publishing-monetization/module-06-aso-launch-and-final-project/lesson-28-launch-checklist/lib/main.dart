...
home:Scaffold(appBar:AppBar(title:const Text('Launch Checklist')),body:const Padding(padding:EdgeInsets.all(16),child:Center(child:Text('Before Launch:\n\n✅ Release build tested\n✅ Version incremented\n✅ Store listing final\n✅ Privacy policy live\n✅ Data Safety accurate\n✅ Real ad IDs set\n✅ Analytics enabled\n✅ Staged rollout configured\n✅ Monitoring plan ready\n\n🚀 GO!',style:TextStyle(color:Colors.white,fontSize:18))))));}}
