...
home:Scaffold(appBar:AppBar(title:const Text('Handling Rejections')),body:const Padding(padding:EdgeInsets.all(16),child:Center(child:Text('Common rejection reasons:\n\n❌ Missing privacy policy\n❌ Misleading metadata\n❌ Broken functionality\n❌ Policy violation (ads, content)\n❌ Incomplete Data Safety\n\nFix → Resubmit → Wait for re-review',style:TextStyle(color:Colors.white,fontSize:18))))));}}
