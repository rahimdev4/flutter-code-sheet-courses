...
home:Scaffold(appBar:AppBar(title:const Text('Privacy & Data Safety')),body:const Padding(padding:EdgeInsets.all(16),child:Center(child:Text('Privacy Policy:\n• Must be hosted at a public URL\n• Describes what data you collect\n• Required for all apps\n\nData Safety:\n• Answer in Play Console\n• What data collected/shared\n• How data is used\n• Encryption in transit?\n• User can request deletion?',style:TextStyle(color:Colors.white,fontSize:18))))));}}
