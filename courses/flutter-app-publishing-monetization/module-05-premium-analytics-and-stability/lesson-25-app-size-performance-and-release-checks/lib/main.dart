...
home:Scaffold(appBar:AppBar(title:const Text('Size & Performance')),body:const Padding(padding:EdgeInsets.all(16),child:Center(child:Text('Check app size:\nflutter build appbundle --analyze-size\n\nOptimize:\n✅ Remove unused assets\n✅ Compress images\n✅ Use --split-per-abi for APK\n✅ Enable tree shaking\n✅ Remove unused packages\n\nTarget: AAB < 50MB',style:TextStyle(color:Colors.white,fontSize:18))))));}}
