...
home:Scaffold(appBar:AppBar(title:const Text('Publish Ready?')),body:const Padding(padding:EdgeInsets.all(16),child:Center(child:Text('A publish-ready app has:\n\n✅ No debug prints or test code\n✅ Proper app icon and splash\n✅ Correct version number\n✅ Release build runs cleanly\n✅ Privacy policy\n✅ Store listing ready\n✅ Tested on real devices',style:TextStyle(color:Colors.white,fontSize:18))))));}}
