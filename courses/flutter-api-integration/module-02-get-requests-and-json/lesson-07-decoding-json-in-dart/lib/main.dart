...
class _MyAppState extends State<MyApp> {
  String _title = 'Press button to fetch';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text('Decoding JSON')),
        body: Center(
          child: Padding(
            padding: const EdgeInsets.all(16),
            child: Text('Title: $_title', style: const TextStyle(color: Colors.white, fontSize: 24)),
          ),
        ),
